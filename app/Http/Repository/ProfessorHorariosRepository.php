...
class ProfessorHorariosRepository extends Repository
{
    ...
    public function horarios($professor)
    {
        $query = $this->query()
            ->selectRaw('phor_diasemana as diasemana, phor_horario as horario')
            ->where('prof_id', '=', $professor)
            ->get();
        return $query;
    }
}